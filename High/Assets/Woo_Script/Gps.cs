...
public class Gps : MonoBehaviour
{
...

    {
...

        {
            ...
            {
                StartCoroutine(SetGPSData());
                gpsInit = true;

                // We start the timer to check each tick (every 3 sec) the current gps position

               // InvokeRepeating("RetrieveGPSData", 0.0001f, 0.1f);//0.0001초에 실행하고 1초마다 해당 함수를 실행합니다.
...

    {
        ...
        //double a = currentGPSPosition.latitude;

        //if (a - currentGPSPosition.latitude == 0)
        //{
        //    woohyuk.text = "값 변화 없음";
        //}
        //else
        //{
        //    woohyuk.text = "값 변화 있음";
        //}
